...
void CGnuplot::SetZLabel(const char* format)
{
    Command("set zlabel '%s'", format);
}
...
void CGnuplot::SetZRange(const double z_min, const double z_max)
{
    Command("set zrange [%f:%f]", z_min, z_max);
}
